...
export const heroes: Hero[] = [
  ...
  { name: "Centaur Warrunner", role: "Offlane", primaryRole: getPrimaryRole("Offlane"), quickTip: "Tank init", keyItems: ["Blink", "Crimson"], synergy: "Snapfire", counters: "Timbersaw", image: 'https://oyster.ignimgs.com/mediawiki/apis.ign.com/dota-2/f/f2/Centaur_Warrunner2.png?width=230&format=jpg&auto=webp&quality=80' },
  ...
  { name: "Keeper of the Light", role: "Support", primaryRole: getPrimaryRole("Support"), quickTip: "Mana", keyItems: ["Aghanim", "Force Staff"], synergy: "PL", counters: "Nyx", image: getHeroImage("Keeper of the Light") },
  {
    name: "Kez",
    role: "Carry",
    primaryRole: getPrimaryRole("Carry"),
    quickTip: "Stance Dance",
    keyItems: ["Manta Style", "Battle Fury", "Sange and Yasha"],
    synergy: "Magnus",
    counters: "Axe",
    image: getHeroImage("Kez")
  },
